...
import static co.com.avvillaspasivos.util.Util.deleteSpecialChar;
...
public class UpdateCrm implements Task {
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    actor.whoCan(CallAnApi.at(ServicePaths.getEndPointBase(DEV_ENV)));
  ...
  private UpdateCrmBody getUpdateCrmBody(ActorData actorData) {
    ...
    return UpdateCrmBody.builder()
        ...
        .lastName(deleteSpecialChar(faker.name().lastName()))
        .secondLastName(deleteSpecialChar(faker.name().lastName()))
        .documentExpDate(1150866000000L)
        .documentExpCity(UPDATE_CRM_CITY)
        .birthCity(UPDATE_CRM_CITY)
        .gender("M")
        .codeCIIU(113)
