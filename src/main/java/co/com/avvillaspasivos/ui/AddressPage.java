...
public class AddressPage {
  ...
  public static final Target FORM_ADDRESS =
      Target.the("Formulario direccion de entrega")
          .located(By.className("box-delivery-address"));
  public static final Target TEXT_CITY =
      Target.the("Campo de texto de ciudad")
          .located(By.id("DeliveryCity"));
  ...
  public static final Target POP_UP =
      Target.the("Pop up de direccion de envio")
          .located(By.xpath("//*[@role='dialog']"));
  public static final Target POP_UP_ACCEPT =
      Target.the("Aceptar cambio de direccion")
          .located(By.id("AcceptChangeDeliveryAddressButton"));
