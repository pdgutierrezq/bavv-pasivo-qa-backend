...
@execution:manual
@automation:pending
Característica: Modificación pop up declarante renta cda
  YO como* cliente
*Necesito* que me informen quienes están obligados a declarar renta
  ...
  Escenario: Pop up cuenta / depósito / nómina digital*
    Dado que  el cliente está abriendo una cuenta / depósito / nómina digital y se encuentra en la pantalla de declarante
