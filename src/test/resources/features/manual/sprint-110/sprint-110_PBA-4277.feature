...
@execution:manual
@automation:pending
Característica: Corrección tipo de extensión cédula permitiendo pdf cda
  YO como* Cliente
*Necesito* cargar mi cédula en formato pdf
  ...
  @manual-result:passed
  @manual-last-tested:sprint-110
  Escenario: Permitir cargue de cédula en pdf nómina*
    Dado que  el cliente está aperturando una cuenta de nómina 
    Cuando  esté en la pantalla de cargue de cédula
    Entonces  debe permitir el cargue del documento en extensiones .PDF, .JPG, .PNG que no tengan un peso ma  YO r a 3MB