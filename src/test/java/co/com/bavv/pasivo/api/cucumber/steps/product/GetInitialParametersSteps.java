...
import static co.com.bavv.pasivo.api.karate.def.KarateStaticResource.PRODUCT_CONFIGURATION;
...
public class GetInitialParametersSteps extends Start {
    ...
    public void elSolicitaLosParametrosInicialesDeLaAplicacion() {
        actor.attemptsTo(KarateRunner.run(PASSIVE_GET, PRODUCT_CONFIGURATION));
    }
}
