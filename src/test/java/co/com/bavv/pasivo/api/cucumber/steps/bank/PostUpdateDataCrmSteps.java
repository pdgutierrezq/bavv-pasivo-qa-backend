...
import com.peterland.karate.api.screenplay.model.var.KarateRequestKey;
import com.peterland.karate.api.screenplay.tasks.KarateRunner;
import io.cucumber.java.es.Cuando;

public class PostUpdateDataCrmSteps extends Start {

    @Cuando("el actualiza la informacion en el CRM del banco en la app de (.*)")
    public void elActualizaLaInformacionEnElCRMDelBanco(KarateRequestKey karateRequestKey) {
