...
import co.com.bavv.old.util.DateManagement;
...
public class ValidateUpdatedData implements Task {
  ...
  public <T extends Actor> void performAs(T actor) {
    UpdateCrmBody updateCrmBody =
        theActorCalled(Constantes.ACTUALIZAR_CRM).recall(SessionVariables.UPDATE_CRM_BODY.name());
  ...
  private static boolean validateDates(Long dateExpected, String tagName) {
    String obtainedDate = UtilWs.getTagValueFromLastResponse(tagName);
