...
public class CallDeleteWith implements Task {

    private final String path;

    public CallDeleteWith(String path) {
        this.path = path;
    }

    public static Performable token(String path) {
        return instrumented(CallDeleteWith.class, path);
    }

    @Override
    @Step("{0} llama servicio Delete con token")
